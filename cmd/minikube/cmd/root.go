...
func init() {
	...
	RootCmd.PersistentFlags().StringP(configCmd.Bootstrapper, "b", bootstrapper.Kubeadm, "The name of the cluster bootstrapper that will set up the Kubernetes cluster.")
